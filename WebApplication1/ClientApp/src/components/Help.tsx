...
const Help = () => (
    ...
    <section>
        ...
        <p>Strona dopiero się rozwija(lub już nie) ale automat powinien wylosować Co kilka pytań a do każdego z nich cztery odpowiedzi, jeśli natrafisz na błąd, zgłoś go w formularzu.</p>
